...
export const LENSES = {
  "dsh-md": {
    title: "dsh.md compliance",
    core: true,
    instruction:
      "Audit the changes for compliance with the dsh.md files from step 2. Note that dsh.md is guidance for the agent as it writes code, so not all instructions apply during review; only flag issues the dsh.md specifically calls out.",
  },
  bugs: {
...
export const DEFAULT_LENS_IDS = ["dsh-md", "bugs", "history", "security", "comments"];
